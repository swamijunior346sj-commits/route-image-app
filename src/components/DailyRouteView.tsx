    ...
    return (
        <div className="relative pl-12 pb-8 group animate-slide-up">
            ...
            <div className={`glass-card rounded-[2rem] p-6 transition-all ${isDone
                ...
                {isNext && (
                    <div className="mt-6 flex gap-2 animate-in fade-in slide-in-from-bottom-2 duration-500">
...
export const DailyRouteView = ({ onNavigateToMap, onNavigateToScanner, onBack }: DailyRouteViewProps) => {
    ...
    return (
        <div className="relative w-full h-full bg-bg-start overflow-hidden flex flex-col font-sans">
            <header className="pt-14 px-6 pb-6 bg-transparent z-10">
                <div className="flex justify-between items-center mb-6">
                    <button onClick={onBack} className="size-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/90">
                        <span className="material-symbols-outlined !text-[24px]">arrow_back_ios_new</span>
                    </button>
                    <div className="glass-card px-4 py-2 rounded-full flex items-center gap-2 border-white/5">
                        <span className="size-2 rounded-full bg-emerald-500 animate-pulse"></span>
                        <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">Status Online</span>
                    </div>
                </div>
